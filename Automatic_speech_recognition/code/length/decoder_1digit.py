...
hypos, refs = [], []
speaker_groups = [r'SNR35dB/man/seq1digit_200_files/*.raw', r'SNR35dB/woman/seq1digit_200_files/*.raw']
...
with open('results/length/1digit.hyp', 'w') as f:
    for hypo in hypos:
        f.write(f'{hypo}\n')

with open('results/length/1digit.ref', 'w') as f:
    for ref in refs:
        f.write(f'{ref}\n')
