...
open('results/speakers/man.hyp', 'w').close()
open('results/speakers/man.ref', 'w').close()
...
for seq, folder in zip(seq_lengths, folders):
    ...
    with open('results/speakers/man.hyp', 'a') as f:
        for hypo in hypos:
            f.write(f'{hypo}\n')
        f.write('\n')

    with open('results/speakers/man.ref', 'a') as f:
        for ref in refs:
            f.write(f'{ref}\n')
        f.write('\n')
