...
folders = [r'SNR25dB/man/seq1digit_200_files/*.raw', r'SNR25dB/man/seq3digits_100_files/*.raw', r'SNR25dB/man/seq5digits_100_files/*.raw']

open('results/noise/SNR25dB.hyp', 'w').close()
open('results/noise/SNR25dB.ref', 'w').close()
...
for seq, folder in zip(seq_lengths, folders):
    ...
    with open('results/noise/SNR25dB.hyp', 'a') as f:
        for hypo in hypos:
            f.write(f'{hypo}\n')
        f.write('\n')

    with open('results/noise/SNR25dB.ref', 'a') as f:
        for ref in refs:
            f.write(f'{ref}\n')
        f.write('\n')
